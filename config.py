...
FRESH_POKEMON_INDICES_FILE = ROOT + "/data/fresh/pokemon_indices"

RAW_POKEMON_BASE_STATS = ROOT + "/data/raw/base_stats"
FRESH_POKEMON_BASE_STATS = ROOT + "/data/fresh/base_stats"

RAW_TYPE_FILE = ROOT + "/data/raw/type_chart"
FRESH_ATTACKER_TYPE_FILE = ROOT + "/data/fresh/attacker_types"
FRESH_DEFENDER_TYPE_FILE = ROOT + "/data/fresh/defender_types"

RAW_HOLD_ITEMS_FILE = ROOT + "/data/raw/hold_items"
FRESH_HOLD_ITEMS = ROOT + "/data/fresh/hold_items"

RAW_MOVES_FILE = ROOT + "/data/raw/detailed_moves"
FRESH_MOVES_FILE = ROOT + "/data/fresh/detailed_moves"
